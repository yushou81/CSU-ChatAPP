...
//                        sendCompressedVideoFrame(bufferedImage, currentTime);
...
//
//    // 视频压缩并发送
//    private void sendCompressedVideoFrame(BufferedImage image, long timestamp) {
//        try {
//            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
//            FFmpegFrameRecorder recorder = new FFmpegFrameRecorder(byteArrayOutputStream, image.getWidth(), image.getHeight());
...
//            sendVideoFrame(compressedImage, timestamp);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
