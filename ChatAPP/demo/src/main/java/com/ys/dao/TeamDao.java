...
public class TeamDao {
    ...
    // 团队名获取团队成员
    public List<Integer> getTeamMembersByName(String teamName) {
    ...
    // 团队名获取团队成员
    public List<Integer> getTeamMembers(String teamId) {

        List<Integer> members = new ArrayList<>();
        String query = "SELECT user_id FROM team_members WHERE team_id = ?";
